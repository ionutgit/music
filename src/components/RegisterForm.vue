<template>
  ...
  <!-- Registration Form -->
  <vee-form :validation-schema="schema" @submit="register" :initial-values="defaultData">
    <!-- Name -->
    <div class="mb-3">
    ...
    <!-- Status -->
    <div class="mb-3">
      <label class="inline-block mb-2">Status music</label>
      <vee-field
        as="select"
        name="status"
        class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition duration-500 focus:outline-none focus:border-black rounded"
    ...
    <div class="mb-3 pl-6">
      ...
      />
      <i18n-t class="inline-block" keypath="register.accept" tag="label" scope="global"><a href="#">{{ $t("register.tos") }}</a></i18n-t>
      <br />
